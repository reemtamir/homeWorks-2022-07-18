...
function showCard() {
  ...
  elCard.innerHTML = `
      <ul class='list-group list-group-flush '>
        ...
        <li class='list-group-item w-50 card-age text-center m-auto'>${ageValue}</li>
        <li class='list-group-item w-50 card-country text-center m-auto'>${countryValue}</li>
        <li class='list-group-item w-50 card-gender text-center m-auto'>${gender}</li>
      </ul>`;
